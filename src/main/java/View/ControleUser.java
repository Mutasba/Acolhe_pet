 ...
 * @author danie
 */
public class ControleUser extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(ControleUser.class.getName());

    /**
     * Creates new form ControleUser
     */

    public ControleUser() {
        initComponents();
        this.setExtendedState(javax.swing.JFrame.MAXIMIZED_BOTH);
        lista.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.LEFT, 15, 15));
        carregarUsuarios(); 
    }
    private void carregarUsuarios() {
        ...
        try {
            ...
            java.util.List<Model_Entety.User> usuarios = sc.ListaUsuario();

            for (Model_Entety.User u : usuarios) {
                ItemUsuarioCadastrado item = new ItemUsuarioCadastrado(u);
                lista.add(item);
            }
        } catch (Exception ex) {
            ex.printStackTrace();
        ...
        // 2. A SOLUÇÃO: Calculamos a largura exata do interior do ScrollPane
        // Subtraímos 20px para garantir que não toca na borda da barra vertical
        int larguraFixa = jScrollPane1.getWidth() - 25;

        // 3. Forçamos o tamanho: Largura FIXA, Altura DINÂMICA
        // Isso impede que o painel cresça horizontalmente
        lista.setPreferredSize(new java.awt.Dimension(larguraFixa, 1000)); 
    ...
    private void initComponents() {
        ...
        label1.setText("Usuários Cadastrados");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new ControleUser().setVisible(true));
    }
